...
<img  src={icon}   className=" mt-2 ml-4 size-15 rounded-xl"/>
<div className="flex flex-col "> 
<h1 className="font-bold text-1xl text-[#091540] mt-4 ml-3  ">{title}</h1>
<p  className=" text-[#7c7b7b]  text-sm ml-3 "  >{description}</p>
</div>
</div>
